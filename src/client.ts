...
const client = (name = '', userAgent = navigator.appVersion) => {
    ...
    if (name) {
        ...
        return {
            IE:
                userAgentL.indexOf('msie') > -1 &&
                userAgentL.indexOf('opera') === -1,
            GECKO:
                userAgentL.indexOf('gecko') > -1 &&
                userAgentL.indexOf('khtml') === -1, // 火狐内核
            WEBKIT: userAgentL.indexOf('applewebkit') > -1, // 苹果、谷歌内核
            OPERA:
                userAgentL.indexOf('opera') > -1 &&
                userAgentL.indexOf('presto') > -1, // opera内核
            ...
            ANDROID:
                ...
                userAgent.indexOf('Adr') > -1, // android终端或者uc浏览器
