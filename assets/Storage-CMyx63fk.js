import{_ as m,N as i,a as fe}from"./FunctionCard.vue_vue_type_script_setup_true_lang-DDIdy86z.js";import{N as ye,b7 as r,b8 as $,b9 as J,ba as q,bb as Se}from"./index-BVibqmd8.js";import{N as k,a as c,B as u,u as xe}from"./index-D8X7QFQD.js";import{k as Ce,H as B,P as l,O as o,Q as t,I as v,R as d,G as D,j as a,W as be,N as Ue,r as n}from"./vue-vendor-BrQLXg1A.js";import{N as H}from"./InputNumber-sx-fYtGl.js";import{N as ze}from"./Switch-Bh39nxm8.js";import{N as he}from"./Select-CnbnSYd8.js";import"./Add-CZHZ8rRD.js";const we={style:{color:"#666","margin-bottom":"24px"}},Ne={class:"code-inline"},De={class:"code-inline"},Ie={key:0,class:"code-block"},je={class:"code-block"},Ve={key:1,style:{color:"#999"}},Oe=Ce({__name:"Storage",setup(Ee){const{t:W}=xe(),f=n("myKey"),I=n("myValue"),b=n(null),g=n(null),j=n([]),O=n(0),U=n("user"),V=n({id:1,name:"John",email:"john@example.com"}),Q=n(null),F=()=>{const p=b.value?{expires:b.value}:void 0;r.local.set(f.value,I.value,p),z()},M=()=>{g.value=r.local.get(f.value)},X=()=>{r.local.delete(f.value),g.value=null,z()},Y=()=>{g.value=r.local.has(f.value)},Z=()=>{r.local.clear(),g.value=null,z()},_=()=>{r.local.set(U.value,V.value,{expires:3600}),z()},ee=()=>{Q.value=r.local.get(U.value)},le=()=>{$.set("directKey","directValue"),g.value=$.get("directKey")},z=()=>{O.value=r.local.length,j.value=r.local.keys()},C=n("sessionKey"),E=n("sessionValue"),h=n(null),y=n(null),oe=()=>{const p=h.value?{expires:h.value}:void 0;r.session.set(C.value,E.value,p)},te=()=>{y.value=r.session.get(C.value)},ae=()=>{r.session.delete(C.value),y.value=null},se=()=>{r.session.clear(),y.value=null},ie=()=>{J.set("directSessionKey","directSessionValue",{expires:60}),y.value=J.get("directSessionKey")},S=n("myCookie"),G=n("cookieValue"),L=n(86400),K=n("/"),R=n(""),T=n(!1),A=n(void 0),x=n(null),w=n({}),ne=[{label:"None",value:"None"},{label:"Lax",value:"Lax"},{label:"Strict",value:"Strict"}],re=()=>{const p={expires:L.value,path:K.value||void 0,domain:R.value||void 0,secure:T.value,sameSite:A.value};r.cookie.set(S.value,G.value,p)},ue=()=>{x.value=r.cookie.get(S.value)},de=()=>{w.value=r.cookie.getAll()},pe=()=>{r.cookie.delete(S.value),x.value=null},ce=()=>{x.value=r.cookie.has(S.value)?"exists":"not exists"},ve=()=>{r.cookie.clear(),w.value={}},ge=()=>{q.set("directCookie","directValue",{expires:3600}),x.value=q.get("directCookie")},N=n(""),me=()=>{try{const p="x".repeat(10485760);r.local.set("largeData",p)}catch(p){p instanceof Se?N.value=`StorageQuotaError: ${p.message}`:N.value=`Unknown error: ${p}`}},P=n(""),ke=()=>{P.value=`storage.local.length: ${r.local.length}
storage.session.length: ${r.session.length}
storage.cookie.has('test'): ${r.cookie.has("test")}`};return(p,e)=>(D(),B("div",null,[l(t(ye),null,{default:o(()=>[...e[14]||(e[14]=[a("Storage",-1)])]),_:1}),v("p",we,d(t(W).categoriesDesc.Storage),1),l(m,{title:"storage.local - localStorage",description:"Unified localStorage API with expiration, generic types, and error handling",since:"6.0.0",tags:["local","namespace"],code:`import { storage } from 'js-cool'
...
const user = storage.local.get<User>('user')`},{input:o(()=>[l(t(i),{vertical:""},{default:o(()=>[l(t(i),{align:"center"},{default:o(()=>[l(t(c),{value:f.value,"onUpdate:value":e[0]||(e[0]=s=>f.value=s),placeholder:"key",style:{width:"120px"}},null,8,["value"]),l(t(c),{value:I.value,"onUpdate:value":e[1]||(e[1]=s=>I.value=s),placeholder:"value",style:{width:"120px"}},null,8,["value"]),l(t(H),{value:b.value,"onUpdate:value":e[2]||(e[2]=s=>b.value=s),placeholder:"expire (s)",style:{width:"120px"},min:0,clearable:""},null,8,["value"])]),_:1}),l(t(i),null,{default:o(()=>[l(t(u),{size:"small",onClick:F},{default:o(()=>[...e[15]||(e[15]=[a("Set",-1)])]),_:1}),l(t(u),{size:"small",onClick:M},{default:o(()=>[...e[16]||(e[16]=[a("Get",-1)])]),_:1}),l(t(u),{size:"small",onClick:Y},{default:o(()=>[...e[17]||(e[17]=[a("Has",-1)])]),_:1}),l(t(u),{size:"small",type:"warning",onClick:X},{default:o(()=>[...e[18]||(e[18]=[a("Delete",-1)])]),_:1}),l(t(u),{size:"small",type:"error",onClick:Z},{default:o(()=>[...e[19]||(e[19]=[a("Clear",-1)])]),_:1})]),_:1})]),_:1})]),result:o(()=>[l(t(i),{vertical:""},{default:o(()=>[l(t(i),{align:"center"},{default:o(()=>[e[20]||(e[20]=v("code",{class:"code-inline"},"Result:",-1)),l(t(k),{type:"info",size:"small",bordered:!1},{default:o(()=>[a(d(g.value??"null"),1)]),_:1})]),_:1}),l(t(i),{align:"center"},{default:o(()=>[v("code",Ne,"Length: "+d(O.value),1),v("code",De,"Keys: "+d(j.value.slice(0,5).join(", "))+d(j.value.length>5?"...":""),1)]),_:1})]),_:1})]),_:1}),l(m,{title:"storage.local - Generic Type Support",description:"Type-safe storage with TypeScript generics",since:"6.0.0",tags:["local","typescript","generic"],code:`interface User { id: number; name: string; email: string }
