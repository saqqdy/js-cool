...
declare const _default: {
    ...
    debounce: (fn: import("../typings/common").AnyFunction, delay: number, immediate: boolean) => () => void;
    throttle: (fn: import("../typings/common").AnyFunction, delay: number, immediate: boolean, debounce: boolean) => () => void;
    stopBubble: typeof stopBubble;
    stopDefault: typeof stopDefault;
    addEvent: {
        (element: import("../typings/common").AnyElement, type: string, handler: import("./addEvent").CustomAnyFunction): void;
        guid: number;
    };
