...
export { addEvent, camel2Dash, clearAttr, clearBr, clearHtml, clearHtmlExpSN, clearHtmlN, clearHtmlNS, clearHtmlTag, client, cutCHSString, dash2Camel, deWxJumpLink, deWxJumpLinkOld, debounce, decodeBase64, decodeUtf8, delCookie, delLocal, delSession, enWxJumpLink, enWxJumpLinkOld, encodeBase64, encodeUtf8, formatTime, formatTimeStr, getAppVersion, getCHSLength, getCookie, getDirParam, getFileType, getIsAppVersionLastest, getLocal, getNumber, getOsVersion, getParameter, getRandomNum, getRandomStr, getRandomStrWidthSpecialChar, getScrollPosition, getSession, getUrlParam, getWindowSize, imgAdapt, imgChoose, isDigitals, isExitsFunction, isExitsVariable, pattern$1 as pattern, removeEvent, setCookie, setLocal, setSession, stopBubble, stopDefault, textareaInsertText, textareaMoveToEnd, throttle, trim, upperFirst };
