...
| `client`                       | (`name`: `string`, `userAgent`: `string`) => `boolean` \| { `ANDROID`: `boolean` ; `GECKO`: `boolean` ; `IE`: `boolean` ; `IOS`: `boolean` = !!userAgent.match(/\(i[^;]+;( U;)? CPU.+Mac OS X/); `IPAD`: `boolean` ; `IPHONE`: `boolean` ; `MOBILE`: `boolean` = !!userAgent.match(/AppleWebKit._Mobile._/); `OPERA`: `boolean` ; `QQ`: `boolean` ; `QQBROWSER`: `boolean` ; `TRIDENT`: `boolean` ; `WEBKIT`: `boolean` ; `WEIXIN`: `boolean` } |
...
| `getDirParam`                  | (`url`: `string`) => { [prop: string]: `any`; }                                                                                                                                                                                                                                                                                                                                                                                                 |
| `getFileType`                  | (`url`: `string`) => `string` \| `null`                                                                                                                                                                                                                                                                                                                                                                                                         |
| `getIsAppVersionLastest`       | (`appName`: `string`, `compareVer`: `string`, `userAgent`: `string`) => `null` \| `boolean`                                                                                                                                                                                                                                                                                                                                                     |
...
▸ `Const` **client**(`name?`, `userAgent?`): `boolean` \| { `ANDROID`: `boolean` ; `GECKO`: `boolean` ; `IE`: `boolean` ; `IOS`: `boolean` = !!userAgent.match(/\(i[^;]+;( U;)? CPU.+Mac OS X/); `IPAD`: `boolean` ; `IPHONE`: `boolean` ; `MOBILE`: `boolean` = !!userAgent.match(/AppleWebKit._Mobile._/); `OPERA`: `boolean` ; `QQ`: `boolean` ; `QQBROWSER`: `boolean` ; `TRIDENT`: `boolean` ; `WEBKIT`: `boolean` ; `WEIXIN`: `boolean` }
...
`boolean` \| { `ANDROID`: `boolean` ; `GECKO`: `boolean` ; `IE`: `boolean` ; `IOS`: `boolean` = !!userAgent.match(/\(i[^;]+;( U;)? CPU.+Mac OS X/); `IPAD`: `boolean` ; `IPHONE`: `boolean` ; `MOBILE`: `boolean` = !!userAgent.match(/AppleWebKit._Mobile._/); `OPERA`: `boolean` ; `QQ`: `boolean` ; `QQBROWSER`: `boolean` ; `TRIDENT`: `boolean` ; `WEBKIT`: `boolean` ; `WEIXIN`: `boolean` }
