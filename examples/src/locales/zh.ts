export default {
	...
	string: {
		...
		lowerFirstDesc: '首字母小写',
		capitalizeDesc: '首字母大写（其余小写）',
	...
	array: {
		...
		countByDesc: '按迭代器计数',
		partitionDesc: '根据条件将数组分成两组',
		findIndexDesc: '查找第一个或最后一个匹配的索引',
		dropTakeDesc: '从数组开头或末尾删除或提取元素',
		iterateeOpsDesc: '带迭代函数的集合操作',
		zipDesc: '按元素组合或分离数组',
		sampleOne: '随机取一个',
		sampleSize: '随机取多个',
	},
