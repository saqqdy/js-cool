export default {
	...
	string: {
		...
		lowerFirstDesc: 'Convert first character to lowercase',
		capitalizeDesc: 'Capitalize first letter (rest lowercase)',
	...
	array: {
		...
		countByDesc: 'Count occurrences by iteratee',
		partitionDesc: 'Split array into two groups by predicate',
		findIndexDesc: 'Find first or last index matching predicate',
		dropTakeDesc: 'Drop or take elements from start or end',
		iterateeOpsDesc: 'Set operations with iteratee function',
		zipDesc: 'Combine or separate arrays element-wise',
