export default {
  ...
  features: {
    utilities: { title: '140+ Utilities', description: 'String, array, object, date, and more' },
  ...
  // Date functions
  date: {
    formatDesc: 'Format date with pattern (supports: YYYY, YY, MM, M, DD, D, HH, H, hh, h, mm, m, ss, s, SSS, A/a)',
