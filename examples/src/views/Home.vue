...
const categories = [
	...
	},
	{
		...
		path: 'object',
		count: 14,
		descriptionEn: 'clone, extend, getProperty, cleanData...',
		descriptionZh: '对象克隆、扩展、获取属性、清理数据...',
	},
	{
		name: 'Typecheck',
		path: 'typecheck',
		count: 15,
		descriptionEn: 'isArray, isObject, isDate, isWindow...',
		descriptionZh: '数组判断、对象判断、日期判断、窗口判断...',
	},
	{
		name: 'Validate',
		path: 'validate',
	...
	},
	{
		...
		path: 'scroll',
		count: 12,
		descriptionEn: 'getPosition, scrollTo, lockScroll...',
		descriptionZh: '获取位置、滚动到、锁定滚动...',
	},
	{
		name: 'Storage',
		path: 'storage',
	...
	},
	{
		...
		path: 'date',
		count: 18,
		descriptionEn: 'formatDate, dateDiff, isToday, isLeapYear...',
		descriptionZh: '格式化日期、日期差、判断今天、闰年...',
	},
	{
		name: 'Color',
		path: 'color',
	...
	},
	{
		...
		path: 'utility',
		count: 15,
		descriptionEn: 'uuid, randomString, fingerprint...',
		descriptionZh: 'UUID生成、随机字符串、浏览器指纹...',
	},
	{
		name: 'Async',
		path: 'async',
		count: 8,
		descriptionEn: 'debounce, throttle, retry, delay...',
		descriptionZh: '防抖、节流、重试、延迟...',
	},
	{
		name: 'Encode',
		path: 'encode',
