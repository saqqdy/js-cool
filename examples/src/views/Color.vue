...
const generateRandom = () => { randomColorResult.value = randomColor(randomMin.value, randomMax.value) }
...
<template>
  <div>
    ...
    >
      <template #input>
        <n-space align="center">
          ...
          <div :style="{ width: '32px', height: '32px', borderRadius: '4px', border: '1px solid #ddd', backgroundColor: hexInput }" />
        </n-space>
      </template>
      <template #result>
        <n-tag type="info" size="small" :bordered="false">{{ JSON.stringify(hexToRGB(hexInput)) }}</n-tag>
      </template>
    </FunctionCard>
    ...
    >
      ...
      <template #result>
        <n-space align="center">
          <n-tag type="info" size="small" :bordered="false">{{ RGBToHex(rgbR, rgbG, rgbB) }}</n-tag>
          <div :style="{ width: '32px', height: '32px', borderRadius: '4px', border: '1px solid #ddd', backgroundColor: RGBToHex(rgbR, rgbG, rgbB) }" />
        </n-space>
      </template>
    </FunctionCard>
    ...
    >
      <template #input>
        <n-space align="center">
          ...
          <div :style="{ width: '32px', height: '32px', borderRadius: '4px', border: '1px solid #ddd', backgroundColor: colorForShade }" />
        </n-space>
      </template>
      <template #result>
        <n-space vertical>
    ...
    >
      <template #input>
        <n-space align="center">
          ...
          <div :style="{ width: '32px', height: '32px', borderRadius: '4px', border: '1px solid #ddd', backgroundColor: colorForCheck }" />
        </n-space>
      </template>
      <template #result>
        <n-space align="center">
          <n-tag size="small" :bordered="false">{{ isLightColor(colorForCheck) ? 'Light' : 'Dark' }}</n-tag>
          <span
            :style="{ display: 'inline-block', padding: '4px 12px', borderRadius: '4px', color: colorForCheck, backgroundColor: isLightColor(colorForCheck) ? '#333' : '#fff' }"
          >
            Sample text
          </span>
        </n-space>
    ...
    >
      <template #input>
        <n-space vertical>
          ...
          <n-space align="center">
            <n-button size="small" type="primary" @click="generateRandom">Generate</n-button>
            <n-tag type="info" size="small" :bordered="false">{{ randomColorResult }}</n-tag>
            <div :style="{ width: '32px', height: '32px', borderRadius: '4px', border: '1px solid #ddd', backgroundColor: randomColorResult }" />
          </n-space>
        </n-space>
      </template>
      <template #result>
        <n-space vertical>
          <div>
            ...
            <n-space style="margin-top: 4px;">
              <div v-for="i in 8" :key="'r'+i" :style="{ width: '32px', height: '32px', borderRadius: '4px', border: '1px solid #ddd', backgroundColor: randomColor() }" />
            </n-space>
          </div>
          <div>
            <code style="font-size: 11px; color: #666;">randomColor([200, 100, 0], [255, 200, 100]) - warm</code>
            <n-space style="margin-top: 4px;">
              <div v-for="(c, i) in warmColors" :key="'w'+i" :style="{ width: '32px', height: '32px', borderRadius: '4px', border: '1px solid #ddd', backgroundColor: c }" />
            </n-space>
          </div>
          <div>
            <code style="font-size: 11px; color: #666;">randomColor([0, 100, 200], [100, 200, 255]) - cool</code>
            <n-space style="margin-top: 4px;">
              <div v-for="(c, i) in coolColors" :key="'c'+i" :style="{ width: '32px', height: '32px', borderRadius: '4px', border: '1px solid #ddd', backgroundColor: c }" />
            </n-space>
          </div>
          <div>
            <code style="font-size: 11px; color: #666;">randomColor(150, 230) - pastel</code>
            <n-space style="margin-top: 4px;">
              <div v-for="(c, i) in pastelColors" :key="'p'+i" :style="{ width: '32px', height: '32px', borderRadius: '4px', border: '1px solid #ddd', backgroundColor: c }" />
            </n-space>
          </div>
        </n-space>
      </template>
