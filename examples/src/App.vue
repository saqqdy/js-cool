...
import { NConfigProvider, NLayout, NLayoutSider, NLayoutHeader, NLayoutContent, NMenu, NInput, NButton, NIcon, NDropdown, NTag, darkTheme } from 'naive-ui'
      ...
      <n-layout>
        ...
        <n-layout-header bordered style="height: 56px; padding: 0 16px; display: flex; align-items: center; justify-content: space-between;">
          ...
          <div class="flex items-center gap-2">
            ...
            <n-button quaternary circle tag="a" href="https://github.com/saqqdy/js-cool" target="_blank">
              <template #icon>
